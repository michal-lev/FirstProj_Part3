...
abstract class HighRankLecturer extends Lecturer implements Comparable<HighRankLecturer> {
    protected String[] articles;
    protected int articleCount;

    public HighRankLecturer(String name, String id, String degreeLevel, String degreeTitle, double salary, Department department) {
    ...
    @Override
    public int compareTo(HighRankLecturer other) {
